...
(() => {
"use strict";
/* harmony import */ var _navbar_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(426);
...
function profile_loadSessions(clearFirst) {
...
document.getElementById("ses-table").addEventListener("click", (event) => {
    ...
    if (event.target.classList.contains("term-btn")) {
        ...
        fetch(sessionUrl + "/" + sessionId, {
            ...
            if (response.status === 200) {
                profile_loadSessions(clearFirst = true);
            }
        });
